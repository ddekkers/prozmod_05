...
implements OMService {
   ...
   static {      
      ...
      if(OMServiceImpl.props.getProperty("regenerate", "0").equals("1")) {            
         ...
         em.persist( new Rate("R_A_10", 0.12, 10, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_9", 0.13, 9, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_8", 0.14, 8, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_7", 0.15, 7, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_6", 0.16, 6, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_5", 0.17, 5, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_4", 0.18, 4, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_3", 0.19, 3, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_2", 0.11, 2, 1000, 1000001, ValidityLevel.A, begin, end));
         em.persist( new Rate("R_A_1", 0.2, 1, 1000, 1000001, ValidityLevel.A, begin, end));
         
         em.persist( new Rate("R_B_10", 0.2, 10, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_9", 0.21, 9, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_8", 0.22, 8, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_7", 0.23, 7, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_6", 0.24, 6, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_5", 0.25, 5, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_4", 0.26, 4, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_3", 0.27, 3, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_2", 0.28, 2, 1000, 1000001, ValidityLevel.B, begin, end));
         em.persist( new Rate("R_B_1", 0.29, 1, 1000, 1000001, ValidityLevel.B, begin, end));
         
         em.persist( new Rate("R_C_10", 0.2, 10, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_9", 0.21, 9, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_8", 0.22, 8, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_7", 0.23, 7, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_6", 0.24, 6, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_5", 0.25, 5, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_4", 0.26, 4, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_3", 0.27, 3, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_2", 0.28, 2, 1000, 1000001, ValidityLevel.C, begin, end));
         em.persist( new Rate("R_C_1", 0.29, 1, 1000, 1000001, ValidityLevel.C, begin, end));
